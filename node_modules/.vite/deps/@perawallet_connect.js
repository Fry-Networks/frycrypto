...
} from "./chunk-6XKVL4WT.js";
import {
  require_lottie_web_light
} from "./chunk-LER7CWN4.js";
import {
  esm_exports,
  init_esm,
  require_algosdk_min,
  require_es5
} from "./chunk-VJJ2MNAE.js";
import "./chunk-FGPW7K3Q.js";
import {
  require_buffer
} from "./chunk-5P6NSFOU.js";
import "./chunk-LMU5GIZH.js";
import {
  __commonJS,
  __toCommonJS
} from "./chunk-GIZG7J7H.js";

// node_modules/@perawallet/connect/dist/App-1ef9f62f.js
var require_App_1ef9f62f = __commonJS({
  "node_modules/@perawallet/connect/dist/App-1ef9f62f.js"() {
    "use strict";
    var e = require_index_b2e0f2c4();
    var n = require_qr_code_styling();
    var t = require_lottie_web_light();
    function a(e2) {
      return e2 && "object" == typeof e2 && "default" in e2 ? e2 : { default: e2 };
    }
    init_esm(), require_algosdk_min(), require_es5();
    var o = a(n);
    var l = a(t);
    function i(e2, n2) {
      void 0 === n2 && (n2 = {});
    ...
    var s = e.isMobile() ? "pera-wallet-modal-header pera-wallet-modal-header--mobile" : "pera-wallet-modal-header pera-wallet-modal-header--desktop";
    p.innerHTML = `
  <div class="${s}">
      ${d() && e.isMobile() ? "" : `<div class="pera-wallet-modal-header__brand">
              ...
              <div class="pera-wallet-modal-header__brand-text">
                ...
                <span class="pera-wallet-modal-header__version-number">v1.3.1</span>
              </div>
            </div>
            `} 
...
`;
    var m = class extends HTMLElement {
      constructor() {
        if (super(), this.attachShadow({ mode: "open" }), this.shadowRoot) {
          ...
          e2.textContent = r, this.shadowRoot.append(p.content.cloneNode(true), e2), this.onClose();
        }
      }
      onClose() {
        var n2;
    ...
    var f = class extends HTMLElement {
      constructor() {
        if (super(), this.attachShadow({ mode: "open" }), this.shadowRoot) {
          const e2 = document.createElement("style");
          e2.textContent = h, this.shadowRoot.append(g.content.cloneNode(true), e2);
        }
      }
      connectedCallback() {
        var n2;
        const t2 = new o.default({ width: 205, height: 205, type: "svg", data: e.PERA_DOWNLOAD_URL, image: w, dotsOptions: { color: "#000", type: "extra-rounded" }, imageOptions: { crossOrigin: "anonymous", margin: 10 }, cornersSquareOptions: { type: "extra-rounded" }, cornersDotOptions: { type: "dot" } }), a2 = null === (n2 = this.shadowRoot) || void 0 === n2 ? void 0 : n2.getElementById("pera-wallet-download-qr-code-wrapper");
        a2 && t2.append(a2);
      }
    };
    ...
    v.textContent = _, C.textContent = u;
    var L = `
  <div id="pera-wallet-connect-modal-desktop-mode" class="pera-wallet-connect-modal-desktop-mode pera-wallet-connect-modal-desktop-mode--default">
      ...
      <div class="pera-wallet-connect-modal-desktop-mode__default-view">
        <div class="pera-wallet-accordion-item pera-wallet-accordion-item--active pera-wallet-accordion-item--web-wallet">
          ...
          ${"EMBEDDED" === e.peraWalletFlowType() ? '<div class="pera-wallet-connect-modal-desktop-mode__web-wallet-iframe"></div>' : `<div class="pera-wallet-connect-modal-desktop-mode__web-wallet">
          <div>
            <div
  ...
  `;
    ...
    var k = class extends HTMLElement {
      constructor() {
        if (super(), this.attachShadow({ mode: "open" }), this.shadowRoot) {
          this.shadowRoot.append(b.content.cloneNode(true), v, C), this.shadowRoot.addEventListener("click", (e2) => {
      ...
      connectedCallback() {
        var n2;
        const t2 = this.getAttribute("should-display-new-badge"), a2 = null === (n2 = this.shadowRoot) || void 0 === n2 ? void 0 : n2.getElementById("pera-web-new-label");
        if ("false" === t2 && (null == a2 || a2.setAttribute("style", "display:none")), this.handleChangeView(), "EMBEDDED" === e.peraWalletFlowType() && this.shadowRoot) {
          const e2 = this.shadowRoot.querySelector(".pera-wallet-connect-modal-desktop-mode__web-wallet-iframe");
          e2 && "true" === this.getAttribute("is-web-wallet-avaliable") && window.onWebWalletConnect(e2);
        }
      }
      handleChangeView() {
        var e2, n2, t2;
      ...
      renderQRCode() {
        ...
        if ("true" === this.getAttribute("compact-mode") && (t2 = 190), n2) {
          const a2 = new o.default({ width: t2, height: t2, type: "svg", data: n2, image: w, dotsOptions: { color: "#000", type: "extra-rounded" }, imageOptions: { crossOrigin: "anonymous", margin: 8 }, cornersSquareOptions: { type: "extra-rounded" }, cornersDotOptions: { type: "dot" } }), l2 = null === (e2 = this.shadowRoot) || void 0 === e2 ? void 0 : e2.getElementById("pera-wallet-connect-modal-connect-qr-code");
          l2 && a2.append(l2);
        }
      }
      onClickDownload() {
    ...
    var E = class extends HTMLElement {
      constructor() {
        ...
        if (super(), this.attachShadow({ mode: "open" }), M.innerHTML = '\n  <div class="pera-wallet-connect-modal-touch-screen-mode">\n    <pera-wallet-connect-modal-information-section></pera-wallet-connect-modal-information-section>\n\n    <div>\n      <a\n        id="pera-wallet-connect-modal-touch-screen-mode-launch-pera-wallet-button"\n        class="pera-wallet-connect-modal-touch-screen-mode__launch-pera-wallet-button"\n        rel="noopener noreferrer"\n        target="_blank">\n        Launch Pera Wallet\n      </a>\n\n      <div\n        class="pera-wallet-connect-modal-touch-screen-mode__new-to-pera-box">\n        <p\n          class="pera-wallet-connect-modal-touch-screen-mode__new-to-pera-box__text"\n          >\n          New to Pera?\n        </p>\n      </div>\n\n      <a\n        href="https://perawallet.app/download/"\n        class="pera-wallet-connect-modal-touch-screen-mode__install-pera-wallet-button"\n        rel="noopener noreferrer"\n        target="_blank">\n        Install Pera Wallet\n      </a>\n    </div>\n  </div>\n', this.shadowRoot) {
          ...
          a2 && o2 && (a2.setAttribute("href", e.generatePeraWalletConnectDeepLink(o2)), a2.addEventListener("click", () => {
            this.onClickLaunch();
          }));
        }
      }
    ...
    var H = class extends HTMLElement {
      constructor() {
        if (super(), this.attachShadow({ mode: "open" }), this.shadowRoot) {
          ...
          n2.textContent = z;
          "true" === this.getAttribute("compact-mode") && (Z = `${Z} ${e.PERA_WALLET_MODAL_CLASSNAME}--compact`), d() && e.isMobile() ? (A.innerHTML = `
        <div class="${Z}">
      ...
      `, this.shadowRoot.append(A.content.cloneNode(true), n2)) : (A.innerHTML = `
          <div class="${Z}">
            <div class="pera-wallet-modal__body">
              ...
              <pera-wallet-modal-desktop-mode id="pera-wallet-modal-desktop-mode" uri="${this.getAttribute("uri")}" is-web-wallet-avaliable="${this.getAttribute("is-web-wallet-avaliable")}" should-display-new-badge="${this.getAttribute("should-display-new-badge")}" compact-mode="${this.getAttribute("compact-mode")}"></pera-wallet-modal-desktop-mode>
            </div>
          </div>
    ...
    var R = class extends HTMLElement {
      constructor() {
        ...
        if (super(), this.attachShadow({ mode: "open" }), this.shadowRoot) {
          ...
          a2.textContent = B, this.shadowRoot.append(F.content.cloneNode(true), a2);
          const o2 = null === (n2 = this.shadowRoot) || void 0 === n2 ? void 0 : n2.getElementById("pera-wallet-redirect-modal-download-pera-link");
          null == o2 || o2.addEventListener("click", () => {
            this.onClose();
          });
          const l2 = null === (t2 = this.shadowRoot) || void 0 === t2 ? void 0 : t2.getElementById("pera-wallet-redirect-modal-launch-pera-link");
          null == l2 || l2.addEventListener("click", () => {
            this.onClose(), window.open(e.generatePeraWalletAppDeepLink(), "_blank");
          });
        }
      }
      connectedCallback() {
        const n2 = window.open(e.generatePeraWalletAppDeepLink(), "_blank");
...
`;
    var $ = class extends HTMLElement {
      constructor() {
        if (super(), this.attachShadow({ mode: "open" }), this.shadowRoot) {
          const n2 = document.createElement("style");
          n2.textContent = N, this.shadowRoot.append(q.content.cloneNode(true), n2);
...
`;
    var Q = class extends HTMLElement {
      constructor() {
        if (super(), this.attachShadow({ mode: "open" }), this.shadowRoot) {
          const e2 = document.createElement("style");
          e2.textContent = G, this.shadowRoot.append(U.content.cloneNode(true), e2);
          if ("true" === this.getAttribute("compact-mode")) {
...
var require_index_b2e0f2c4 = __commonJS({
  "node_modules/@perawallet/connect/dist/index-b2e0f2c4.js"(exports) {
    ...
    var c = new class {
      ...
      sendMessage({ message: e2, targetWindow: t2, origin: n2, timeout: a2 = 1e3 }) {
        setTimeout(() => {
          const a3 = { channel: this.channel, message: e2 };
          t2.postMessage(a3, { targetOrigin: n2 || "*" });
        }, a2);
      }
      close() {
    ...
    function d() {
      ...
      let { title: n2 } = document, a2 = "";
      return e2 instanceof HTMLMetaElement && (n2 = e2.content), t2 instanceof HTMLMetaElement && (a2 = t2.content), { title: n2, description: a2, url: window.location.origin, favicon: u()[0] };
    }
    function u() {
      const e2 = document.getElementsByTagName("link"), t2 = [];
      for (let n2 = 0; n2 < e2.length; n2++) {
        const a2 = e2[n2], o2 = a2.getAttribute("rel");
        if (o2 && o2.toLowerCase().indexOf("icon") > -1) {
          const e3 = a2.getAttribute("href");
    ...
    function p(e2) {
      return new Promise((t2, n2) => {
        try {
          const a2 = window.open(e2, "_blank");
          let o2 = 0;
          const r2 = setInterval(() => {
            ...
            a2 && (true === a2.closed && (clearInterval(r2), n2(new l({ type: "OPERATION_CANCELLED" }, "Operation cancelled by user"))), c.sendMessage({ message: { type: "TAB_OPEN" }, origin: e2, targetWindow: a2 }));
          }, 700);
          c.setupListener({ onReceiveMessage: (e3) => {
            "TAB_OPEN_RECEIVED" === e3.data.message.type && (clearInterval(r2), t2(a2));
          } });
        } catch (e3) {
          n2(e3);
        }
    ...
    var m = "pera-wallet-connect-modal-wrapper";
    function w(e2) {
    ...
    function g(e2, t2) {
      var n2, a2, o2, r2;
      const i2 = document.getElementById(e2), s2 = null === (a2 = null === (n2 = null == i2 ? void 0 : i2.querySelector(e2.replace("-wrapper", ""))) || void 0 === n2 ? void 0 : n2.shadowRoot) || void 0 === a2 ? void 0 : a2.querySelector(".pera-wallet-modal"), l2 = null === (r2 = null === (o2 = null == s2 ? void 0 : s2.querySelector("pera-wallet-modal-header")) || void 0 === o2 ? void 0 : o2.shadowRoot) || void 0 === r2 ? void 0 : r2.getElementById("pera-wallet-modal-header-close-button");
      null == l2 || l2.addEventListener("click", () => {
        t2(), E(e2);
      });
    }
    function h() {
      w("pera-wallet-redirect-modal-wrapper").innerHTML = "<pera-wallet-redirect-modal></pera-wallet-redirect-modal>";
    }
    function v({ isCompactMode: e2 }) {
      const t2 = w("pera-wallet-sign-txn-modal-wrapper");
      t2.innerHTML = `<pera-wallet-sign-txn-modal compact-mode=${e2}></pera-wallet-sign-txn-modal>`;
      const n2 = t2.querySelector("pera-wallet-sign-txn-modal");
      return n2 ? (a2 = n2, o2 = "pera-wallet-sign-txn-modal__body__content", new Promise((e3) => {
        var t3;
        const n3 = null === (t3 = a2.shadowRoot) || void 0 === t3 ? void 0 : t3.querySelector(`.${o2}`);
        if (n3)
          return e3(n3);
        const r2 = new MutationObserver(() => {
          n3 && (e3(n3), r2.disconnect());
        });
        r2.observe(a2, { childList: true, subtree: true });
      })) : Promise.reject();
      var a2, o2;
    }
    function f(e2) {
      E("pera-wallet-sign-txn-modal-wrapper"), e2 && e2(new l({ type: "SIGN_TXN_CANCELLED" }, "Transaction sign is cancelled"));
    }
    function N() {
      w("pera-wallet-sign-txn-toast-wrapper").innerHTML = "<pera-wallet-sign-txn-toast></pera-wallet-sign-txn-toast>";
    }
    function E(e2) {
    ...
    function C(e2) {
      var t2, n2, a2, o2, r2;
      const i2 = "connect" === e2 ? m : "pera-wallet-sign-txn-modal-wrapper", s2 = null === (a2 = null === (n2 = null === (t2 = document.getElementById(i2)) || void 0 === t2 ? void 0 : t2.querySelector(i2.replace("-wrapper", ""))) || void 0 === n2 ? void 0 : n2.shadowRoot) || void 0 === a2 ? void 0 : a2.querySelector(".pera-wallet-modal");
      return null === (r2 = null === (o2 = null == s2 ? void 0 : s2.querySelector("pera-wallet-modal-header")) || void 0 === o2 ? void 0 : o2.shadowRoot) || void 0 === r2 ? void 0 : r2.getElementById("pera-wallet-modal-header-close-button");
    }
    var I = "PeraWallet.Wallet";
    var T = "walletconnect";
    function b() {
    ...
    function y(e2, t2) {
      var n2;
      null === (n2 = b()) || void 0 === n2 || n2.setItem(I, JSON.stringify({ type: t2 || "pera-wallet", accounts: e2, selectedAccount: e2[0] }));
    }
    function A() {
      var e2;
      const t2 = null === (e2 = b()) || void 0 === e2 ? void 0 : e2.getItem(I);
    ...
    function _() {
      return new Promise((e2, t2) => {
        var n2, a2;
        try {
          null === (n2 = b()) || void 0 === n2 || n2.removeItem(T), null === (a2 = b()) || void 0 === a2 || a2.removeItem(I), e2(void 0);
        } catch (e3) {
          t2(e3);
        }
      });
    ...
    function R() {
      return D() && /Android/i.test(navigator.userAgent);
    }
    function x() {
      return D() && /iPhone|iPad|iPod/i.test(navigator.userAgent);
    }
    function P() {
      return D() && /iPhone|iPod|Android/i.test(navigator.userAgent);
    }
    function B() {
      if (!D())
        return null;
    ...
    function k() {
      return "Chrome" === B() ? "EMBEDDED" : "NEW_TAB";
    }
    var U = R() ? "algorand://" : "perawallet-wc://";
    function j(e2) {
    ...
    function G(e2 = true) {
      let t2 = U;
      const n2 = B();
      return e2 && n2 && (t2 = `${t2}?browser=${encodeURIComponent(n2)}`), t2;
    }
    function $(e2, t2) {
      const n2 = new URL(e2);
      return n2.searchParams.append("embedded", "true"), t2 && n2.searchParams.append("compactMode", "true"), n2.toString();
    }
    function q({ method: e2, signTxnRequestParams: t2, signer: n2, chainId: a2, webWalletURL: o2, isCompactMode: r2, resolve: i2, reject: d2 }) {
      const u2 = j(o2);
      switch (k()) {
        case "EMBEDDED":
          !function() {
            s(this, void 0, void 0, function* () {
              const o3 = yield v({ isCompactMode: r2 }), s2 = document.createElement("iframe"), p2 = $(u2.TRANSACTION_SIGN, r2), m2 = `hid ${p2}; bluetooth ${p2}`;
              if (s2.setAttribute("id", "pera-wallet-iframe"), s2.setAttribute("src", p2), s2.setAttribute("allow", m2), null == o3 || o3.appendChild(s2), g("pera-wallet-sign-txn-modal-wrapper", () => d2(new l({ type: `${e2}_CANCELLED` }, "Transaction signing is cancelled by user."))), s2.contentWindow) {
                let o4 = 0;
                const r3 = setInterval(() => {
                  var e3;
                  o4 += 1, 50 !== o4 ? (c.sendMessage({ message: { type: "IFRAME_INITIALIZED" }, origin: u2.TRANSACTION_SIGN, targetWindow: s2.contentWindow }), null === (e3 = C("sign-txn")) || void 0 === e3 || e3.addEventListener("click", () => {
                    clearInterval(r3);
                  })) : clearInterval(r3);
                }, 700);
                c.setupListener({ onReceiveMessage: (o5) => function({ event: e3, peraWalletIframe: t3, signTxnRequestParams: n3, isIframeInitializedChecker: a3, webWalletURLs: o6, signer: r4, chainId: i3, method: s3, resolve: d3, reject: u3 }) {
                  var p3, m3, w2, g2;
                  switch (e3.data.message.type) {
                    case "IFRAME_INITIALIZED_RECEIVED": {
                      let e4;
                      clearInterval(a3), "SIGN_TXN" === s3 ? e4 = { type: "SIGN_TXN", txn: n3 } : "SIGN_DATA" === s3 && r4 && i3 && (e4 = { type: "SIGN_DATA", data: n3, signer: r4, chainId: i3 }), e4 && c.sendMessage({ message: e4, origin: $(o6.TRANSACTION_SIGN), targetWindow: t3.contentWindow });
                      break;
                    }
                    case "SIGN_TXN_CALLBACK":
                      null === (p3 = document.getElementById("pera-wallet-iframe")) || void 0 === p3 || p3.remove(), f(), d3(e3.data.message.signedTxns.map((e4) => O(e4.signedTxn)));
                      break;
                    case "SIGN_DATA_CALLBACK":
                      null === (m3 = document.getElementById("pera-wallet-iframe")) || void 0 === m3 || m3.remove(), f(), d3(e3.data.message.signedData.map((e4) => O(e4.signedData)));
                      break;
                    case "SIGN_TXN_NETWORK_MISMATCH":
                      u3(new l({ type: `${s3}_NETWORK_MISMATCH`, detail: e3.data.message.error }, e3.data.message.error || "Network mismatch"));
                      break;
                    case "SIGN_TXN_CALLBACK_ERROR":
                      null === (w2 = document.getElementById("pera-wallet-iframe")) || void 0 === w2 || w2.remove(), f(), u3(new l({ type: `${s3}_CANCELLED` }, e3.data.message.error));
                      break;
                    case "SESSION_DISCONNECTED":
                      null === (g2 = document.getElementById("pera-wallet-iframe")) || void 0 === g2 || g2.remove(), f(), _(), u3(new l({ type: "SESSION_DISCONNECTED", detail: e3.data.message.error }, e3.data.message.error));
                  }
                }({ event: o5, signTxnRequestParams: t2, peraWalletIframe: s2, isIframeInitializedChecker: r3, webWalletURLs: u2, method: e2, signer: n2, chainId: a2, resolve: i2, reject: d2 }) });
              }
            });
          }();
          break;
        case "NEW_TAB":
          !function() {
            s(this, void 0, void 0, function* () {
              try {
                const o3 = yield p(u2.TRANSACTION_SIGN);
                if (o3) {
                  let r4;
                  "SIGN_TXN" === e2 ? r4 = { type: "SIGN_TXN", txn: t2 } : "SIGN_DATA" === e2 && n2 && a2 && (r4 = { type: "SIGN_DATA", data: t2, signer: n2, chainId: a2 }), r4 && c.sendMessage({ message: r4, origin: u2.TRANSACTION_SIGN, targetWindow: o3 });
                }
                const r3 = setInterval(() => {
                  true === (null == o3 ? void 0 : o3.closed) && (d2(new l({ type: `${e2}_CANCELLED` }, "Transaction signing is cancelled by user.")), clearInterval(r3));
                }, 2e3);
                c.setupListener({ onReceiveMessage: (t3) => function({ event: e3, newPeraWalletTab: t4, method: n3, resolve: a3, reject: o4 }) {
                  switch (e3.data.message.type) {
                    case "SIGN_TXN_CALLBACK":
                      null == t4 || t4.close(), a3(e3.data.message.signedTxns.map((e4) => O(e4.signedTxn)));
                      break;
                    case "SIGN_DATA_CALLBACK":
                      null == t4 || t4.close(), a3(e3.data.message.signedData.map((e4) => O(e4.signedData)));
                      break;
                    case "SIGN_TXN_NETWORK_MISMATCH":
                      o4(new l({ type: `${n3}_NETWORK_MISMATCH`, detail: e3.data.message.error }, e3.data.message.error || "Network mismatch"));
                      break;
                    case "SIGN_TXN_CALLBACK_ERROR":
                      null == t4 || t4.close(), o4(new l({ type: `${n3}_CANCELLED` }, e3.data.message.error));
                      break;
                    case "SESSION_DISCONNECTED":
                      null == t4 || t4.close(), _(), o4(new l({ type: "SESSION_DISCONNECTED", detail: e3.data.message.error }, e3.data.message.error));
                  }
                }({ event: t3, newPeraWalletTab: o3, method: e2, resolve: i2, reject: d2 }) });
              } catch (e3) {
                d2(e3);
              }
            });
    ...
    function K({ webWalletURL: e2, chainId: t2, isCompactMode: n2, resolve: a2, reject: o2 }) {
      const r2 = j(e2);
      return "EMBEDDED" === k() ? function(e3) {
        const i3 = document.createElement("iframe");
        if (i3.setAttribute("id", "pera-wallet-iframe"), i3.setAttribute("src", $(r2.CONNECT, n2)), e3.appendChild(i3), i3.contentWindow) {
          let e4 = 0;
          const n3 = setInterval(() => {
            var t3;
            e4 += 1, 50 !== e4 ? (c.sendMessage({ message: { type: "IFRAME_INITIALIZED" }, origin: r2.CONNECT, targetWindow: i3.contentWindow }), null === (t3 = C("connect")) || void 0 === t3 || t3.addEventListener("click", () => {
              clearInterval(n3);
            })) : clearInterval(n3);
          }, 700);
          c.setupListener({ onReceiveMessage: (e5) => function({ event: e6, peraWalletIframe: t3, chainId: n4, isIframeInitializedChecker: a3, webWalletURLs: o3, resolve: r3, reject: i4 }) {
            var s2, u2, w2, g2, h2, v2;
            switch (e6.data.message.type) {
              case "IFRAME_INITIALIZED_RECEIVED":
                clearInterval(a3), c.sendMessage({ message: { type: "CONNECT", data: Object.assign(Object.assign({}, d()), { chainId: n4 }) }, origin: o3.CONNECT, targetWindow: t3.contentWindow });
                break;
              case "CONNECT_CALLBACK": {
                const t4 = e6.data.message.data.addresses;
                y(t4, "pera-wallet-web"), r3(t4), E(m), null === (s2 = document.getElementById("pera-wallet-iframe")) || void 0 === s2 || s2.remove();
                break;
              }
              case "CONNECT_NETWORK_MISMATCH":
                i4(new l({ type: "CONNECT_NETWORK_MISMATCH", detail: e6.data.message.error }, e6.data.message.error || "Your wallet is connected to a different network to this dApp. Update your wallet to the correct network (MainNet or TestNet) to continue.")), E(m), null === (u2 = document.getElementById("pera-wallet-iframe")) || void 0 === u2 || u2.remove();
                break;
              case "CREATE_PASSCODE_EMBEDDED":
                p(o3.CONNECT).then((e7) => {
                  e7 && c.sendMessage({ message: { type: "CONNECT", data: Object.assign(Object.assign({}, d()), { chainId: n4 }) }, origin: o3.CONNECT, targetWindow: e7 });
                  const t4 = setInterval(() => {
                    true === (null == e7 ? void 0 : e7.closed) && (i4(new l({ type: "CONNECT_CANCELLED" }, "Connect is cancelled by user")), E(m), clearInterval(t4));
                  }, 2e3);
                  c.setupListener({ onReceiveMessage: (t5) => {
                    if (r3 && "CONNECT_CALLBACK" === t5.data.message.type) {
                      const n5 = t5.data.message.data.addresses;
                      y(n5, "pera-wallet-web"), r3(n5), E(m), null == e7 || e7.close();
                    }
                  } });
                });
                break;
              case "SELECT_ACCOUNT_EMBEDDED": {
                const e7 = document.getElementById(m), n5 = null === (g2 = null === (w2 = null == e7 ? void 0 : e7.querySelector("pera-wallet-connect-modal")) || void 0 === w2 ? void 0 : w2.shadowRoot) || void 0 === g2 ? void 0 : g2.querySelector(".pera-wallet-modal"), a4 = null === (v2 = null === (h2 = null == n5 ? void 0 : n5.querySelector("pera-wallet-modal-desktop-mode")) || void 0 === h2 ? void 0 : h2.shadowRoot) || void 0 === v2 ? void 0 : v2.querySelector(".pera-wallet-connect-modal-desktop-mode");
                n5 && a4 && (n5.classList.add("pera-wallet-modal--select-account"), n5.classList.remove("pera-wallet-modal--create-passcode"), a4.classList.add("pera-wallet-connect-modal-desktop-mode--select-account"), a4.classList.remove("pera-wallet-connect-modal-desktop-mode--create-passcode")), c.sendMessage({ message: { type: "SELECT_ACCOUNT_EMBEDDED_CALLBACK" }, origin: o3.CONNECT, targetWindow: t3.contentWindow });
                break;
              }
            }
          }({ event: e5, peraWalletIframe: i3, chainId: t2, isIframeInitializedChecker: n3, webWalletURLs: r2, resolve: a2, reject: o2 }) });
        }
      } : function() {
        return s(this, void 0, void 0, function* () {
          try {
            const e3 = yield p(r2.CONNECT);
            e3 && c.sendMessage({ message: { type: "CONNECT", data: Object.assign(Object.assign({}, d()), { chainId: t2 }) }, origin: r2.CONNECT, targetWindow: e3 });
            const n3 = setInterval(() => {
              true === (null == e3 ? void 0 : e3.closed) && (o2(new l({ type: "CONNECT_CANCELLED" }, "Connect is cancelled by user")), clearInterval(n3), i2());
            }, 2e3);
            c.setupListener({ onReceiveMessage: (t3) => function({ event: e4, newPeraWalletTab: t4, resolve: n4, reject: a3 }) {
              if (n4 && "CONNECT_CALLBACK" === e4.data.message.type) {
                const a4 = e4.data.message.data.addresses;
                y(a4, "pera-wallet-web"), n4(a4), E(m), null == t4 || t4.close();
              } else
                "CONNECT_NETWORK_MISMATCH" === e4.data.message.type && (a3(new l({ type: "CONNECT_NETWORK_MISMATCH", detail: e4.data.message.error }, e4.data.message.error || "Your wallet is connected to a different network to this dApp. Update your wallet to the correct network (MainNet or TestNet) to continue.")), E(m), null == t4 || t4.close());
            }({ event: t3, newPeraWalletTab: e3, resolve: a2, reject: o2 }) });
          } catch (e3) {
            i2(), o2(e3);
          }
        });
    ...
    function X({ isWebWalletAvailable: e2, shouldDisplayNewBadge: t2, shouldUseSound: n2, compactMode: a2 }) {
      return { open: (o2 = { isWebWalletAvailable: e2, shouldDisplayNewBadge: t2, shouldUseSound: n2, compactMode: a2 }, (e3) => {
        if (!document.getElementById(m)) {
          const t3 = w(m), n3 = `${e3}&algorand=true`, { isWebWalletAvailable: a3, shouldDisplayNewBadge: r2, shouldUseSound: i2, compactMode: s2 } = o2;
          t3.innerHTML = `<pera-wallet-connect-modal uri="${n3}" is-web-wallet-avaliable="${a3}" should-display-new-badge="${r2}" should-use-sound="${i2}" compact-mode="${s2}"></pera-wallet-connect-modal>`;
        }
      }), close: () => E(m) };
      var o2;
    }
    "undefined" != typeof window && (window.global = window, window.Buffer = window.Buffer || require_buffer().Buffer, Promise.resolve().then(function() {
      return require_App_1ef9f62f();
      ...
      get isConnected() {
        var e2;
        return "mobile" === this.platform ? !!this.connector : "web" === this.platform && !!(null === (e2 = A()) || void 0 === e2 ? void 0 : e2.accounts.length);
      }
      connect() {
        return new Promise((e2, t2) => s(this, void 0, void 0, function* () {
          ...
          try {
            ...
            const { isWebWalletAvailable: a2, bridgeURL: r2, webWalletURL: i2, shouldDisplayNewBadge: s2, shouldUseSound: c2 } = yield W(), d2 = K({ resolve: e2, reject: t2, webWalletURL: i2, chainId: this.chainId, isCompactMode: this.compactMode });
            a2 && (window.onWebWalletConnect = d2), this.connector = new o.default({ bridge: this.bridge || r2 || "https://bridge.walletconnect.org", qrcodeModal: X({ isWebWalletAvailable: a2, shouldDisplayNewBadge: s2, shouldUseSound: c2, compactMode: this.compactMode }) }), yield this.connector.createSession({ chainId: this.chainId || 4160 }), g(m, () => t2(new l({ type: "CONNECT_MODAL_CLOSED" }, "Connect modal is closed by user"))), this.connector.on("connect", (n3, a3) => {
              var o2, r3;
              n3 && t2(n3), e2((null === (o2 = this.connector) || void 0 === o2 ? void 0 : o2.accounts) || []), y((null === (r3 = this.connector) || void 0 === r3 ? void 0 : r3.accounts) || []);
            });
          } catch (e3) {
        ...
        return new Promise((e2, t2) => s(this, void 0, void 0, function* () {
          ...
          try {
            ...
            if ("pera-wallet-web" === (null == r2 ? void 0 : r2.type)) {
              const { isWebWalletAvailable: n3 } = yield W();
            ...
            this.connector && e2(this.connector.accounts || []), this.bridge = (null === (n2 = function() {
              var e3;
              const t3 = null === (e3 = b()) || void 0 === e3 ? void 0 : e3.getItem(T);
              return t3 ? JSON.parse(t3) : null;
            }()) || void 0 === n2 ? void 0 : n2.bridge) || "", this.bridge && (this.connector = new o.default({ bridge: this.bridge }), e2((null === (a2 = this.connector) || void 0 === a2 ? void 0 : a2.accounts) || [])), this.isConnected || e2([]);
          } catch (e3) {
      ...
      signTransactionWithMobile(e2) {
        return s(this, void 0, void 0, function* () {
          const t2 = M("algo_signTxn", [e2]);
          try {
            try {
              const { silent: e3 } = yield W(), n2 = (yield this.connector.sendCustomRequest(t2, { forcePushNotification: !e3 })).filter(Boolean);
              return "string" == typeof n2[0] ? n2.map(O) : n2.map((e4) => Uint8Array.from(e4));
            } catch (e3) {
              return yield Promise.reject(new l({ type: "SIGN_TRANSACTIONS", detail: e3 }, e3.message || "Failed to sign transaction"));
            }
          } finally {
            E("pera-wallet-redirect-modal-wrapper"), E("pera-wallet-sign-txn-toast-wrapper");
          }
        });
      }
      signTransactionWithWeb(e2, t2) {
        return new Promise((n2, a2) => q({ signTxnRequestParams: e2, webWalletURL: t2, method: "SIGN_TXN", isCompactMode: this.compactMode, resolve: n2, reject: a2 }));
      }
      signDataWithMobile({ data: e2, signer: t2, chainId: n2 }) {
        return s(this, void 0, void 0, function* () {
          const a2 = M("algo_signData", e2.map((e3) => Object.assign(Object.assign({}, e3), { signer: t2, chainId: n2 })));
          try {
            try {
              const { silent: e3 } = yield W(), t3 = (yield this.connector.sendCustomRequest(a2, { forcePushNotification: !e3 })).filter(Boolean);
              return "string" == typeof t3[0] ? t3.map(O) : t3.map((e4) => Uint8Array.from(e4));
            } catch (e3) {
              return yield Promise.reject(new l({ type: "SIGN_TRANSACTIONS", detail: e3 }, e3.message || "Failed to sign transaction"));
            }
          } finally {
      ...
      signDataWithWeb({ data: e2, signer: t2, chainId: n2, webWalletURL: a2 }) {
        return new Promise((o2, r2) => q({ method: "SIGN_DATA", signTxnRequestParams: e2, signer: t2, chainId: n2, webWalletURL: a2, isCompactMode: this.compactMode, resolve: o2, reject: r2 }));
      }
      signTransaction(e2, t2) {
        return s(this, void 0, void 0, function* () {
          if ("mobile" === this.platform && (P() ? h() : !P() && this.shouldShowSignTxnToast && N(), !this.connector))
          ...
          const n2 = e2.flatMap((e3) => e3.map((e4) => function(e5, t3) {
            ...
            const a2 = { txn: (o2 = e5.txn, Buffer.from(r.default.encodeUnsignedTransaction(o2)).toString("base64")) };
            var o2;
            return Array.isArray(n3) && (a2.signers = n3), e5.authAddr && (a2.authAddr = e5.authAddr), e5.message && (a2.message = e5.message), e5.msig && (a2.msig = e5.msig), a2;
          }(e4, t2)));
          if ("web" === this.platform) {
            const { webWalletURL: e3 } = yield W();
      ...
      signData(e2, t2) {
        return s(this, void 0, void 0, function* () {
          ...
          if ("mobile" === this.platform && (P() ? h() : !P() && this.shouldShowSignTxnToast && N(), !this.connector))
            throw new Error("PeraWalletConnect was not initialized correctly.");
          if ("web" === this.platform) {
            const { webWalletURL: a2 } = yield W();
            return this.signDataWithWeb({ data: e2, signer: t2, chainId: n2, webWalletURL: a2 });
          }
          return this.signDataWithMobile({ data: e2, signer: t2, chainId: n2 });
        });
      }
    }, exports.closePeraWalletSignTxnToast = function() {
      E("pera-wallet-sign-txn-toast-wrapper");
    }, exports.generatePeraWalletAppDeepLink = G, exports.generatePeraWalletConnectDeepLink = function(e2) {
      let t2 = G(false);
      x() && !t2.includes("-wc") && (t2 = t2.replace("://", "-wc://"));
      let n2 = `${t2}wc?uri=${encodeURIComponent(e2)}`;
      const a2 = B();
      return R() && (n2 = e2), a2 && (n2 = `${n2}&browser=${encodeURIComponent(a2)}`), n2;
    }, exports.isIOS = x, exports.isMobile = P, exports.peraWalletFlowType = k, exports.removeModalWrapperFromDOM = E;
  }
});
...
var require_dist = __commonJS({
  "node_modules/@perawallet/connect/dist/index.js"(exports) {
    ...
    var e = require_index_b2e0f2c4();
    init_esm(), require_algosdk_min(), require_es5(), exports.PeraWalletConnect = e.PeraWalletConnect, exports.closePeraWalletSignTxnToast = e.closePeraWalletSignTxnToast;
  }
});
