...
declare type SignTransactionFlowMethod = "SIGN_TXN" | "SIGN_DATA";
...
interface EmbeddedSignTransactionFlowTellerReducerParams extends SignTransactionFlowPromise {
...
interface NewTabSignTransactionFlowTellerReducerParams extends SignTransactionFlowPromise {
    event: MessageEvent<TellerMessage<PeraTeller>>;
    newPeraWalletTab: Window | null;
    method: SignTransactionFlowMethod;
}
export type { SignTransactionFlowPromise, RunSignTransactionFlowParams, EmbeddedSignTransactionFlowTellerReducerParams, NewTabSignTransactionFlowTellerReducerParams };
